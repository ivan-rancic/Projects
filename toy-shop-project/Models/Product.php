...
class Product extends Model
{
    ...
    public static function getSixRandomProductsP($offset, $no_of_records_per_page)
    {
        $newArray = array_slice(self::getAvailableProducts(), $offset, $no_of_records_per_page, true);
        return $newArray;
    }
